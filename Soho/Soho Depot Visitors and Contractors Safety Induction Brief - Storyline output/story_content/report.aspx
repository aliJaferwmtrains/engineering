...
function execCrossDomainRequest() {
    ...
    var list = clientContext.get_web().get_lists().getByTitle("Soho Quiz Results");
    ...
    clientContext.executeQueryAsync(
        function () {
            ...
            if (localStorage["RegistrationId"]) {
                redirectUrl += "/Lists/Soho Visits/NewForm.aspx?QuizResultID=" + item.get_id();
                redirectUrl += "&RegistrationID=" + localStorage["RegistrationId"];
            }
            else {
                redirectUrl += "/Lists/Soho Visitors/NewForm.aspx?QuizResultID=https://realliferailway.sharepoint.com/sites/inductions/Lists/Soho%20Quiz%20Results/DispForm.aspx?ID=" + item.get_id() + "&desc=QuizResult";
                if (jQuery("table.questions tr").length > 11) {
            ...
            redirectUrl += "&Source=" + "https://realliferailway.sharepoint.com/sites/inductions/SitePages/Soho.aspx";

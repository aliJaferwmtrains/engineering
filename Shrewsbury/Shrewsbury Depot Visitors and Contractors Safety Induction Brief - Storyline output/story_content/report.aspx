...
function execCrossDomainRequest() {
    ...
    var list = clientContext.get_web().get_lists().getByTitle("Shrewsbury Quiz Result");
    ...
    clientContext.executeQueryAsync(
        function () {
            ...
            if (localStorage["RegistrationId"]) {
                redirectUrl += "/Lists/Shrewsbury Visits/NewForm.aspx?QuizResultID=" + item.get_id();
                redirectUrl += "&RegistrationID=" + localStorage["RegistrationId"];
            }
            else {
                redirectUrl += "/Lists/Shrewsbury Visitors/NewForm.aspx?QuizResultID=https://realliferailway.sharepoint.com/sites/inductions/Lists/Shrewsbury%20Quiz%20Result/DispForm.aspx?ID=" + item.get_id() + "&desc=QuizResult";
                if (jQuery("table.questions tr").length > 11) {
            ...
            redirectUrl += "&Source=" + "https://realliferailway.sharepoint.com/sites/inductions/SitePages/Shrewsbury.aspx";

...
function PrintResults()
{
	...
	var reportHtml = window.open(GetBasePath() + g_strContentFolder + "/report.aspx", "Reports");
...
function CloseWebObject(strId)
{
	...
	oWebObject.IFrame.src = g_strContentFolder + "/blank.aspx";
	oWebObject.strUrl = "";
...
function OpenSwfWindow(strFileName, nWidth, nHeight, strStatus, strToolbar, strLocation, strMenubar, strScrollbars, strResizable)
{
	...
	g_wndSwf = window.open(GetBasePath() + g_strContentFolder + "/swf.aspx?" + strSearch, "SwfWnd", strOptions);
	g_wndLast = g_wndSwf;
}

...
<head>
    ...
    <!-- version: 3.2.13213.0 -->
    <title>Camden Carriage Sidings Visitors and Contractors Safety Induction Brief</title>
    ...
    <style rel="stylesheet" data-noprefix>
        ...
        body.is-mobile, body.is-theme-unified {
            background: black
        }
        ...
        .is-mobile .load-container, .is-theme-unified .load-container {
            position: absolute;
            left: 0;
            top: 0;
            width: 100%;
        ...
        .is-mobile .hide-slide-loader .load-container, .is-theme-unified .hide-slide-loader .load-container {
            opacity: 0;
            visibility: hidden
        }

        .is-mobile .slide-loader, .is-theme-unified .slide-loader {
        ...
        .is-theme-unified .slide-loader {
            ...
            .is-mobile .slide-loader .mobile-loader-dot, .is-theme-unified .slide-loader .mobile-loader-dot {
                width: 30px;
                height: 30px;
            ...
            .is-mobile .slide-loader .dot1, .is-theme-unified .slide-loader .dot1 {
            ...
            .is-mobile .slide-loader .dot2, .is-theme-unified .slide-loader .dot2 {
    ...
    <script>
        strContentLocation = "story_html5.aspx";
...
<mso:Order msdt:dt="string">417300.000000000</mso:Order>
...
<body class="cs-HTML is-theme-classic" role="application">
    ...
    <script type="text/javascript">
        if (window.isMobile.any || window.globals.themeName === 'unified') {
            var doc = document, loader = doc.body.querySelector('.slide-loader');[1, 2, 3].forEach(function (n) {
                var d = doc.createElement('div'); d.classList.add('mobile-loader-dot'); d.classList.add('dot' + n); loader.appendChild(d);
            });
        }
    </script>

    <div class="mobile-load-title-overlay">
        <div class="mobile-load-title">Camden Carriage Sidings Visitors and Contractors Safety Induction Brief</div>
    </div>
    <script>
    ...
    <iframe name="AICCComm" src="lms/AICCComm.aspx" style="display:none;"></iframe>
    <iframe name="rusticisoftware_aicc_results" src="lms/blank.aspx" style="display:none;"></iframe>
    <iframe name="NothingFrame" src="lms/blank.aspx" style="display:none;"></iframe>

...
<head>
    ...
    <script language="JavaScript">
        ...
        function GetBlankHtmlPage(seed) {
            ...
            objXMLHTTP.open("GET", "blank.aspx?random=" + seed + (Math.random()), false);
...
<mso:Order msdt:dt="string">426600.000000000</mso:Order>
...
<body onload="DetectPreferredCommMethod();" onunload="ProcessUnload();" onbeforeunload="ProcessUnload();">
    ...
    <iframe id="AICCFrame"
            ...
            src="blank.aspx" onload="IFrameLoaded();"></iframe>

    <form name="frmAICC" method="Post" action="blank.aspx" target="AICCFrame" ID="Form1">

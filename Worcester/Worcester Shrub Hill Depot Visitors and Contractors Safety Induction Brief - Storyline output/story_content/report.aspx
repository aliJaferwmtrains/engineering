...
function execCrossDomainRequest() {
    ...
    var list = clientContext.get_web().get_lists().getByTitle("Worcester Quiz Results");
    ...
    clientContext.executeQueryAsync(
        function () {
            ...
            if (localStorage["RegistrationId"]) {
                redirectUrl += "/Lists/Worcester Visits/NewForm.aspx?QuizResultID=" + item.get_id();
                redirectUrl += "&RegistrationID=" + localStorage["RegistrationId"];
            }
            else {
                redirectUrl += "/Lists/Worcester Visitors/NewForm.aspx?QuizResultID=https://realliferailway.sharepoint.com/sites/inductions/Lists/Worcester%20Quiz%20Results/DispForm.aspx?ID=" + item.get_id() + "&desc=Quiz Result";
                if (jQuery("table.questions tr").length > 11) {
            ...
            redirectUrl += "&Source=" + "https://realliferailway.sharepoint.com/sites/inductions/SitePages/Worcester.aspx";
